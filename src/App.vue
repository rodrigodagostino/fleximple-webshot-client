		...
		<main class="site-main">
			<form @submit.prevent="requestScreenshot" class="form card">
				...
				<div class="form-control">
					...
					<select name="file-type" id="file-type" class="form-field" v-model="fileType">
			...
			>
				...
				<p v-else-if="successNotification" class="notification notification--success">
					Screenshot generated successfully!
				</p>
				<p v-else-if="errorNotification" class="notification notification--error">
